...
namespace DGPDatabase.DGPSec
{
    public class GroupRead
    {
        ...
        public GroupRead(string connStr)
        {
            _connstr = connStr;
        }
        ...
        public bool DupeCheck(string userName, string webSvcName)
        {
            ...
            using (SqlCommand sqlCmd = new SqlCommand())
            {
                ...
                if (idcheck.Rows.Count > 0)
                {
                    ...
                    SvrErrLog.LogError(userName, webSvcName, "DataGroups_read_dml.DupeCheck", "Duplicate active rec_gid", duplist);
                }
                ...
                if (valcheck.Rows.Count > 0)
                {
                    ...
                    SvrErrLog.LogError(userName, webSvcName, "DataGroups_read_dml.DupeCheck", "Duplicate active values", duplist);
                }
            }
