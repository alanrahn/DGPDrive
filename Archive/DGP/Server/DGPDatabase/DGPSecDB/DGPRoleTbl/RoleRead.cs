...
namespace DGPDatabase.DGPSec
{
    public class RoleRead
    {
        ...
        public RoleRead(string connStr)
        {
            _connstr = connStr;
        }
        ...
        public bool GetDupeCount(string userName, string webSvcName)
        {
            ...
            using (SqlCommand sqlCmd = new SqlCommand())
            {
                ...
                DataTable idcheck = dBUtil.DupeCheckByID(DGPSecTables.DGPRole, _connstr);
                ...
                if (idcheck.Rows.Count > 0)
                {
                    ...
                    SvrErrLog.LogError(userName, webSvcName, "RoleRead.GetDupeCount", "Duplicate active rec_gid", duplist);
                }
                ...
                if (valcheck.Rows.Count > 0)
                {
                    ...
                    SvrErrLog.LogError(userName, webSvcName, "RoleRead.GetDupeCount", "Duplicate active values", duplist);
                }
            }
        ...
        public string GetDestCounts(string srcdbname)
        {
            ...
            string maxdestsrcid = dbUtil.GetMaxSrcID(srcdbname, DGPSecTables.DGPRole, _connstr);

            string destsrccount = dbUtil.GetDestRecCount(srcdbname, DGPSecTables.DGPRole, _connstr);
        ...
        public string GetSrcCounts(string srcdbname, string maxdestid)
        {
            ...
            string srccount = dbUtil.GetSrcRecCount(srcdbname, DGPSecTables.DGPRole, "0", _connstr);

            string srcdestcount = dbUtil.GetSrcRecCount(srcdbname, DGPSecTables.DGPRole, maxdestid, _connstr);
        ...
        public DataTable GetSrcRecs(string srcdbname, string placeholderid, string maxbatch)
        {
            ...
            DBUtil dBUtil = new DBUtil();
            return dBUtil.GetSrcRecs(srcdbname, DGPSecTables.DGPRole, placeholderid, srcbatch, _connstr);
        }
