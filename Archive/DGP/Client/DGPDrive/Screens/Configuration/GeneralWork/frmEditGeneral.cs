...
namespace DGPDrive.Screens.Configuration
{
    public partial class frmEditGeneral : Form
    {
        ...
        public frmEditGeneral(HttpClient httpClient, MainForm mainForm, ucGeneralWork parentForm, string latestGID)
        {
            ...
            {
                RemErrLog.LogException(_main.Encrypted, _main.UserName, _main.Password, _main.SvcUrl, "DGP Lattice", "frmEditGeneral", ex);
        ...
        private void PopulateForm()
        {
            try
            {
                ...
                methparams.Add(CmnFields.SchemaFlag, BoolVal.TRUE);
                methparams.Add(CmnFields.rec_gid, _latestgid);
                ...
                RespInfo respinfo = msgUtil.ApiMethHelper(_main.Encrypted,
                                                            methList,
                                                            reqID,
                                                            _main.UserName,
                                                            _main.Password,
