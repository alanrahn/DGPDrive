...
namespace DGPDrive.Screens.FileStore
{
    public partial class ucFileStore : UserControl
    {
        ...
        private void downloadMenuItem_Click(object sender, EventArgs e)
        {
            ...
            frmFileDownload fileDownload = new frmFileDownload(_httpClient, _main, this, _shardname, _filegid, _fileversion, _filename, _fileext, _filedate, _filesize.ToString(), _filehash, _segsize.ToString(), _totalseg.ToString());
