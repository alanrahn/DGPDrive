...
namespace DGPDrive.Screens.User
{
    public partial class frmEditSelf : Form
    {
        ...
        public frmEditSelf(MainForm mainForm)
        {
            InitializeComponent();
            ...
            {
                RemoteErrLog.LogException(_main.UserName, _main.Password, _main.SvcUrl, "DGP DGP", "frmEditSelf", ex);
        ...
        private void Populate()
        {
            ...
            {
                RemoteErrLog.LogException(_main.UserName, _main.Password, _main.SvcUrl, "DGP DGP", "frmEditSelf.Populate", ex);
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            {
                RemoteErrLog.LogException(_main.UserName, _main.Password, _main.SvcUrl, "DGP DGP", "frmEditSelf.btnSave_Click", ex);
