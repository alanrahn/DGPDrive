...
namespace DGPDrive.Screens.Testing
{
    public partial class frmAutoWorkLog : Form
    {
        ...
        public frmAutoWorkLog(MainForm mainForm)
        {
            InitializeComponent();
            ...
            {
                RemoteErrLog.LogException(_main.UserName, _main.Password, _main.SvcUrl, "DGP DGP", "frmAutoWorkLog", ex);
        ...
        public void SetPageSize()
        {
            try
            {
                ...
                string methList = msgUtil.CreateXMLMethod("AutoWorkLog.GetPageSize.base", methparams);
                ...
                if (respmsg != "")
                {
                    ...
                    ResInfo methresult = msgUtil.GetResult("AutoWorkLog.GetPageSize.base_DEFAULT", methresults);
                    ...
                    {
                        RemoteErrLog.LogError(_main.UserName, _main.Password, _main.SvcUrl, "DGP DGP", "frmAutoWorkLog.SetPageSize", "PageSize Error", "Error querying for the frmAutoWorkLog page size.");
            ...
            {
                RemoteErrLog.LogException(_main.UserName, _main.Password, _main.SvcUrl, "DGP DGP", "frmAutoWorkLog.SetPageSize", ex);
        ...
        public void Search()
        {
            ...
            try
            {
                ...
                if (respmsg != "")
                {
                    ...
                    RespInfo respinfo = new RespInfo();
                    Dictionary<string, ResInfo> methresults = msgUtil.ReadResponseString(respinfo, respmsg);
                    _main.SetMetrics(2, sw.Elapsed.TotalMilliseconds, Convert.ToDouble(respinfo.SvrMS), "DGP", "frmAutoWork");
                    ...
                    else
                    {
                        ...
                        RemoteErrLog.LogError(_main.UserName, _main.Password, _main.SvcUrl, "DGP DGP", "frmAutoWorkLog.GetSearch", "Authentication error.", errmsg);
            ...
            {
                RemoteErrLog.LogException(_main.UserName, _main.Password, _main.SvcUrl, "DGP DGP", "frmAutoWorkLog.GetSearch", ex);
        ...
        private void dgvAutoWorkLog_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            try
            {
                ...
                MsgUtil msgUtil = new MsgUtil();
                string reqID = msgUtil.GetNewGID();
                string methList = msgUtil.CreateXMLMethod("AutoWorkLog.GetProcSteps.base", methparams);
                SOAPMsgUtil soapmsg = new SOAPMsgUtil();
                string respmsg = soapmsg.SOAPApiHelper(methList, reqID, _main.UserName, _main.Password, _main.SvcUrl, _main.SvcPubKey);
                ...
                if (respmsg != "")
                {
                    ...
                    ResInfo methresult = msgUtil.GetResult("AutoWorkLog.GetProcSteps.base_DEFAULT", methresults);
                    ...
                    {
                        RemoteErrLog.LogError(_main.UserName, _main.Password, _main.SvcUrl, "DGP DGP", "frmAutoWorkLog.dgvAutoWorkLog_CellClick", "ProcSteps Error", "Error querying for the frmAutoWorkLog ProcSteps content.");
            ...
            {
                RemoteErrLog.LogException(_main.UserName, _main.Password, _main.SvcUrl, "DGP DGP", "frmAutoWorkLog.dgvAutoWorkLog_CellClick", ex);
