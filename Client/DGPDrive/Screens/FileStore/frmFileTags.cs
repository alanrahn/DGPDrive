...
namespace DGPDrive.Screens.FileStore
{
    public partial class frmFileTags : Form
    {
        ...
        public frmFileTags(MainForm mainForm, ucFileStore parentForm, string fileGID, string fileName)
        {
            InitializeComponent();
            ...
            {
                RemoteErrLog.LogException(_main.UserName, _main.Password, _main.SvcUrl, "DGP DGP", "frmFileTags", ex);
        ...
        private void PopulateGrids()
        {
            try
            {
                ...
                if (respmsg != "")
                {
                    ...
                    {
                        RemoteErrLog.LogError(_main.UserName, _main.Password, _main.SvcUrl, "DGP DGP", "frmFileTags:PopulateGrids", "Authentication error.", "Authorization error = " + respinfo.Auth);
            ...
            {
                RemoteErrLog.LogException(_main.UserName, _main.Password, _main.SvcUrl, "DGP DGP", "frmFileTags.PopulateGrids", ex);
        ...
        private void dgvAvailableTags_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            {
                RemoteErrLog.LogException(_main.UserName, _main.Password, _main.SvcUrl, "DGP DGP", "frmFileTags.dgvAvailTags_CellDoubleClick", ex);
        ...
        private void dgvAssignedTags_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            {
                RemoteErrLog.LogException(_main.UserName, _main.Password, _main.SvcUrl, "DGP DGP", "frmFileTags.dgvAssignedMethods_CellDoubleClick", ex);
