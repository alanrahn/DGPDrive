...
namespace DGPDrive.Screens.FileStore
{
    public partial class frmFileUpload : Form
    {
        ...
        public frmFileUpload(HttpClient httpClient, MainForm mainForm, ucFileStore parentForm, DGPNode selNode, string folderPath, string action, string rec_gid, string filename, string filedescrip, string row_ms, string version)
        { 
            InitializeComponent();
            ...
            {
                RemoteErrLog.LogException(_main.UserName, _main.Password, _main.SvcUrl, "DGP DGP", "frmFileUpload", ex);
        ...
        private void btnBrowse_Click(object sender, EventArgs e)
        {
            ...
            {
                RemoteErrLog.LogException(_main.UserName, _main.Password, _main.SvcUrl, "DGP DGP", "frmFileUpload.btnBrowse_Click", ex);
        ...
        private void bw_DoWork2(object sender, DoWorkEventArgs e)
        {
                ...
                if (_filedata.FileBytes > 0 && _filedata.FileBytes <= Convert.ToInt64(_main.MaxFileSize))
                {
                    ...
                    if (respmsg != "")
                    {
                        ...
                        if (shardresult.RCode.ToUpper() == APIResult.OK)
                        {
                            ...
                            string filerespmsg = msgUtil.ApiMethHelper(filemethList,
                                                                        reqID,
                                                                        _main.UserName,
                                                                        _main.Password,
                                                                        _httpClient,
                                ...
                                if (defres.RCode.ToUpper() == APIResult.OK)
                                {
                                    ...
                                    for (int x = 1; x <= _totalSeg; x++)
                                    {
                                        ...
                                        if (tmparray.Length > 0)
                                        {
                                            ...
                                            string shardrespmsg = msgUtil.ApiMethHelper(shardmethList,
                                                                                            reqID,
                                                                                            _main.UserName,
                                                                                            _main.Password,
                                                                                            _httpClient,
                                    ...
                                    else
                                    {
                                        ...
                                        string removerespmsg = msgUtil.ApiMethHelper(removemethList,
                                                                                        reqID,
                                                                                        _main.UserName,
                                                                                        _main.Password,
                                                                                        _httpClient,
            ...
            {
                RemoteErrLog.LogException(_main.UserName, _main.Password, _main.SvcUrl, "DGP DGP", "frmFileUpload.btnUpload_Click", ex);
            ...
            else
            {
                ...
                RemoteErrLog.LogError(_main.UserName, _main.Password, _main.SvcUrl, "DGP DGP", "frmFileUpload.btnUpload_Click", "File Upload Process Error", procmsg);
            }
