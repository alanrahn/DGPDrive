...
namespace DGPDrive.Screens.FileStore
{
    public partial class frmEditTag : Form
    {
        ...
        public frmEditTag(MainForm mainForm, ucTags parentForm, string tagGID)
        {
            InitializeComponent();
            ...
            {
                RemoteErrLog.LogException(_main.UserName, _main.Password, _main.SvcUrl, "DGP DGP", "frmEditTag", ex);
        ...
        private void Populate()
        {
            ...
            {
                RemoteErrLog.LogException(_main.UserName, _main.Password, _main.SvcUrl, "DGP DGP", "frmEditTag.Populate", ex);
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            {
                RemoteErrLog.LogException(_main.UserName, _main.Password, _main.SvcUrl, "DGP DGP", "frmEditTag.btnSave_Click", ex);
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            {
                RemoteErrLog.LogException(_main.UserName, _main.Password, _main.SvcUrl, "DGP DGP", "frmEditTag.btnDelete_Click", ex);
