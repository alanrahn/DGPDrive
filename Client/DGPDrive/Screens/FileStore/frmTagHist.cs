...
namespace DGPDrive.Screens.FileStore
{
    public partial class frmTagHist : Form
    {
        ...
        public frmTagHist(MainForm mainForm, ucTags parentForm, string tagGID, string tagName)
        {
            InitializeComponent();
            ...
            {
                RemoteErrLog.LogException(_main.UserName, _main.Password, _main.SvcUrl, "DGP DGP", "frmTagHist", ex);
