...
{
    public partial class ucTags : UserControl, IDriveUC
    {
        MainForm _main;
        ...
        public ucTags(MainForm main)
        {
            ...
            {
                RemoteErrLog.LogException(_main.UserName, _main.Password, _main.SvcUrl, "DGP DGP", "ucTags", ex);
        ...
        public void SetPageSize()
        {
            try
            {
                ...
                string methList = msgUtil.CreateXMLMethod("Tag.GetPageSize.base", methparams);
                ...
                if (respmsg != "")
                {
                    ...
                    ResInfo methresult = msgUtil.GetResult("Tag.GetPageSize.base_DEFAULT", methresults);
                    ...
                    {
                        RemoteErrLog.LogError(_main.UserName, _main.Password, _main.SvcUrl, "DGP DGP", "ucTags.SetPageSize", "", "");
            ...
            {
                RemoteErrLog.LogException(_main.UserName, _main.Password, _main.SvcUrl, "DGP DGP", "ucTags.SetPageSize", ex);
        ...
        public void Search()
        {
            ...
            try
            {
                ...
                if (respmsg != "")
                {
                    ...
                    else
                    {
                        ...
                        RemoteErrLog.LogError(_main.UserName, _main.Password, _main.SvcUrl, "DGP DGP", "ucTags.GetSearch", "Authentication error.", errmsg);
            ...
            {
                RemoteErrLog.LogException(_main.UserName, _main.Password, _main.SvcUrl, "DGP DGP", "ucTags.GetSearch", ex);
        ...
        {
            frmEditTag editTag = new frmEditTag(_main, this, "");
            editTag.ShowDialog();
        }
        ...
        {
            frmEditTag editTag = new frmEditTag(_main, this, GID);
            editTag.ShowDialog();
        }
        ...
        {
            frmTagHist tagHist = new frmTagHist(_main, this, GID, _tagname);
            tagHist.ShowDialog();
        }
