...
namespace DGPDrive.Screens.FileStore
{
    public partial class frmFileHist : Form
    {
        ...
        public frmFileHist(MainForm mainForm, ucFileStore parentForm, string fileGID, string fileName)
        {
            InitializeComponent();
            ...
            try
            {
                ...
                string methList = msgUtil.CreateXMLMethod("File.GetHistory.base", methparams);
                ...
                if (respmsg != "")
                {
                    ...
                    ResInfo methresult = msgUtil.GetResult("File.GetHistory.base_DEFAULT", methresults);
            ...
            {
                RemoteErrLog.LogException(_main.UserName, _main.Password, _main.SvcUrl, "DGP DGP", "frmFileHist", ex);
        ...
        private void btnDownloadSelected_Click(object sender, EventArgs e)
        {
            ...
            string _segsize = dgvFileHistory.SelectedRows[0].Cells[FileFields.SegSize].Value.ToString();
            ...
            frmFileDownload2 fileDownload = new frmFileDownload2(_main, _parent, _shardname, _filegid, _version, _filename, _fileext, _filedate, _filesize, _filehash, _segsize, _totalseg);
