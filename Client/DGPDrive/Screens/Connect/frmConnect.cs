...
namespace DGPDrive.Screens.Connect
{
    public partial class frmConnect : Form
    {
        DGPSOAPSvc.DGPSOAPSvc _soapsvc;
        MainForm _main;
        ...
        public frmConnect(MainForm mainForm)
        {
            InitializeComponent();
            ...
            try
            {
                ...
                _soapsvc = new DGPSOAPSvc.DGPSOAPSvc();
                _main = mainForm;
            ...
            {
                RemoteErrLog.LogException(_main.UserName, _main.Password, _main.SvcUrl, "DGP DGP", "frmConnect", ex);
        ...
        private void btnBrowse_Click(object sender, EventArgs e)
        {
            ...
            {
                RemoteErrLog.LogException(_main.UserName, _main.Password, _main.SvcUrl, "DGP DGP", "frmConnect.btnBrowse_Click", ex);
        ...
        private void btnClear_Click(object sender, EventArgs e)
        {
            ...
            _main.WebSvcName = "";
            _main.WebSvcVerStr = "";
            _main.WebSvcVer = DateTime.MinValue;
            _main.MaxFileSize = "";
            _main.MaxSegSize = "";
            _main.MinPwordLen = "";
            _main.UserGID = "";
        ...
        private void btnConnect_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (_main.SvcUrl.Substring(0, 5).ToLower() == "https")
                {
                    _main.SvcPubKey = "";
                    _main.TLS = false;
                }
                ...
                {
                    _main.TLS = true;
                    // get and store web service public key
                    _main.SvcPubKey = _soapsvc.GetPubKey();
                }
                ...
                if (respmsg != "")
                {
                    ...
                    _main.SetMetrics(1, sw.Elapsed.TotalMilliseconds, Convert.ToDouble(respinfo.SvrMS), "DGPDrive", "frmConnect");
                        ...
                        if (apiUser != null)
                        {
                            if (apiUser.RCode.ToUpper() == APIResult.OK)
                            {
                                ...
                                if (docfrag.SelectNodes("LoginResults") != null && docfrag.SelectNodes("LoginResults").ToString() != "")
                                {
                                    ...
                                    _main.LocState = docfrag.SelectSingleNode("//LocState").InnerText;
                                    ...
                                    connResult += "<p class=\"success\">LocState = " + _main.LocState + ".</p>";
                ...
                {
                    connResult += "<p class=\"error\">Respons Message Error: No response message was returned.</p>";
                }
        }
            catch (Exception ex)
            {
