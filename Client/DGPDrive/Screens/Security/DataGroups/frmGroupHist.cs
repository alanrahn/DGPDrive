...
namespace DGPDrive.Screens.Security
{
    public partial class frmGroupHist : Form
    {
        ...
        public frmGroupHist(MainForm mainForm, ucDataGroup parentForm, string groupGID, string groupName)
        {
            InitializeComponent();
            ...
            {
                RemoteErrLog.LogException(_main.UserName, _main.Password, _main.SvcUrl, "DGP DGP", "frmGroupHist", ex);
