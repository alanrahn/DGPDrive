...
namespace DGPDrive.Screens.Security
{
    public partial class frmEditGroup : Form
    {
        ...
        public frmEditGroup(MainForm mainForm, ucDataGroup parentForm, string groupGID)
        {
            InitializeComponent();
            ...
            {
                RemoteErrLog.LogException(_main.UserName, _main.Password, _main.SvcUrl, "DGP DGP", "frmEditGroup", ex);
        ...
        private void Populate()
        {
            ...
            {
                RemoteErrLog.LogException(_main.UserName, _main.Password, _main.SvcUrl, "DGP DGP", "frmEditGroup.Populate", ex);
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            {
                RemoteErrLog.LogException(_main.UserName, _main.Password, _main.SvcUrl, "DGP DGP", "frmEditGroup.btnSave_Click", ex);
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            {
                RemoteErrLog.LogException(_main.UserName, _main.Password, _main.SvcUrl, "DGP DGP", "frmEditGroup.btnDelete_Click", ex);
