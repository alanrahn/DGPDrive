...
namespace DGPDrive.Screens.Security
{
    public partial class frmUserHist : Form
    {
        ...
        public frmUserHist(MainForm mainForm, ucApiUsers parentForm, string userGID, string userName)
        {
            InitializeComponent();
            ...
            try
            {
                ...
                string methList = msgUtil.CreateXMLMethod("APIUser.GetHistory.base", methparams);
                ...
                if (respmsg != "")
                {
                    ...
                    ResInfo methresult = msgUtil.GetResult("APIUser.GetHistory.base_DEFAULT", methresults);
            ...
            {
                RemoteErrLog.LogException(_main.UserName, _main.Password, _main.SvcUrl, "DGP DGP", "frmUserHist", ex);
