...
namespace DGPDrive.Screens.Security
{
    public partial class frmUserGroups : Form
    {
        ...
        public frmUserGroups(MainForm mainForm, ucApiUsers parentForm, string userGID, string userName)
        {
            InitializeComponent();
            ...
            {
                RemoteErrLog.LogException(_main.UserName, _main.Password, _main.SvcUrl, "DGP DGP", "frmUserGroups", ex);
        ...
        private void PopulateGrids()
        {
            try
            {
                ...
                if (respmsg != "")
                {
                    ...
                    {
                        RemoteErrLog.LogError(_main.UserName, _main.Password, _main.SvcUrl, "DGP DGP", "frmUserGroups.PopulateGrids", "Authentication error.", "Authorization error = " + respinfo.Auth);
            ...
            {
                RemoteErrLog.LogException(_main.UserName, _main.Password, _main.SvcUrl, "DGP DGP", "frmUserGroups.PopulateGrids", ex);
        ...
        private void dgvAvailableGroups_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            try
            {
                ...
                MsgUtil msgUtil = new MsgUtil();
                string reqID = msgUtil.GetNewGID();
                string methList = msgUtil.CreateXMLMethod("GroupUser.Assign.base", methparams);
                SOAPMsgUtil soapmsg = new SOAPMsgUtil();
                string respmsg = soapmsg.SOAPApiHelper(methList, reqID, _main.UserName, _main.Password, _main.SvcUrl, _main.SvcPubKey);
                ...
                if (respmsg != "")
                {
                    ...
                    ResInfo methresult = msgUtil.GetResult("GroupUser.Assign.base_DEFAULT", methresults);
            ...
            {
                RemoteErrLog.LogException(_main.UserName, _main.Password, _main.SvcUrl, "DGP DGP", "frmUserGroups.dgvAvailableGroups_CellContentDoubleClick", ex);
        ...
        private void dgvAssignedGroups_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            try
            {
                ...
                MsgUtil msgUtil = new MsgUtil();
                string reqID = msgUtil.GetNewGID();
                string methList = msgUtil.CreateXMLMethod("GroupUser.Remove.base", methparams);
                SOAPMsgUtil soapmsg = new SOAPMsgUtil();
                string respmsg = soapmsg.SOAPApiHelper(methList, reqID, _main.UserName, _main.Password, _main.SvcUrl, _main.SvcPubKey);
                ...
                if (respmsg != "")
                {
                    ...
                    ResInfo methresult = msgUtil.GetResult("GroupUser.Remove.base_DEFAULT", methresults);
            ...
            {
                RemoteErrLog.LogException(_main.UserName, _main.Password, _main.SvcUrl, "DGP DGP", "frmUserGroups.dgvAssignedGroups_CellContentDoubleClick", ex);
