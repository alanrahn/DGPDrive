...
namespace DGPDrive.Screens.Security
{
    public partial class frmEditUser : Form
    {
        ...
        public frmEditUser(MainForm mainForm, ucApiUsers parentForm, string userGID)
        {
            InitializeComponent();
            ...
            {
                RemoteErrLog.LogException(_main.UserName, _main.Password, _main.SvcUrl, "DGP DGP", "frmEditUser", ex);
        ...
        private void Populate()
        {
            ...
            {
                RemoteErrLog.LogException(_main.UserName, _main.Password, _main.SvcUrl, "DGP DGP", "frmEditUser.Populate", ex);
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            {
                RemoteErrLog.LogException(_main.UserName, _main.Password, _main.SvcUrl, "DGP DGP", "frmEditUser.btnSave_Click", ex);
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            {
                RemoteErrLog.LogException(_main.UserName, _main.Password, _main.SvcUrl, "DGP DGP", "frmEditUser.btnDelete_Click", ex);
