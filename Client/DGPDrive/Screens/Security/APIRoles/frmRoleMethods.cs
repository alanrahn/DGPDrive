...
namespace DGPDrive.Screens.Security
{
    public partial class frmRoleMethods : Form
    {
        ...
        public frmRoleMethods(MainForm mainForm, ucApiRoles parentForm, string roleGID, string roleName)
        {
            InitializeComponent();
            ...
            {
                RemoteErrLog.LogException(_main.UserName, _main.Password, _main.SvcUrl, "DGP DGP", "frmRoleMethods", ex);
        ...
        private void PopulateApiList()
        {
            ...
            string methList = msgUtil.CreateXMLMethod("APIMethod.GetAPIList.base", methparams);
            ...
            if (respmsg != "")
            {
                ...
                ResInfo methresult = msgUtil.GetResult("APIMethod.GetAPIList.base_DEFAULT", methresults);
        ...
        private void PopulateGrids()
        {
            try
            {
                ...
                if (respmsg != "")
                {
                    ...
                    {
                        RemoteErrLog.LogError(_main.UserName, _main.Password, _main.SvcUrl, "DGP DGP", "frmRoleMethods.PopulateGrids", "Authentication error.", "Authorization error = " + respinfo.Auth);
            ...
            {
                RemoteErrLog.LogException(_main.UserName, _main.Password, _main.SvcUrl, "DGP DGP", "frmRoleMethods.PopulateGrids", ex);
        ...
        private void dgvAvailMethods_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            try
            {
                ...
                MsgUtil msgUtil = new MsgUtil();
                string reqID = msgUtil.GetNewGID();
                string methList = msgUtil.CreateXMLMethod("RoleMethod.Assign.base", methparams);
                SOAPMsgUtil soapmsg = new SOAPMsgUtil();
                string respmsg = soapmsg.SOAPApiHelper(methList, reqID, _main.UserName, _main.Password, _main.SvcUrl, _main.SvcPubKey);
                ...
                if (respmsg != "")
                {
                    ...
                    ResInfo methresult = msgUtil.GetResult("RoleMethod.Assign.base_DEFAULT", methresults);
            ...
            {
                RemoteErrLog.LogException(_main.UserName, _main.Password, _main.SvcUrl, "DGP DGP", "frmRoleMethods.dgvAvailMethods_CellDoubleClick", ex);
        ...
        private void dgvAssignedMethods_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            try
            {
                ...
                MsgUtil msgUtil = new MsgUtil();
                string reqID = msgUtil.GetNewGID();
                string methList = msgUtil.CreateXMLMethod("RoleMethod.Remove.base", methparams);
                SOAPMsgUtil soapmsg = new SOAPMsgUtil();
                string respmsg = soapmsg.SOAPApiHelper(methList, reqID, _main.UserName, _main.Password, _main.SvcUrl, _main.SvcPubKey);
                ...
                if (respmsg != "")
                {
                    ...
                    ResInfo methresult = msgUtil.GetResult("RoleMethod.Remove.base_DEFAULT", methresults);
            ...
            {
                RemoteErrLog.LogException(_main.UserName, _main.Password, _main.SvcUrl, "DGP DGP", "frmRoleMethods.dgvAssignedMethods_CellDoubleClick", ex);
