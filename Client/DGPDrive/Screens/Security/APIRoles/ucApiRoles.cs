...
{
    public partial class ucApiRoles : UserControl, IDriveUC
    {
        MainForm _main;
        ...
        public ucApiRoles(MainForm main)
        {
            InitializeComponent();
            ...
            {
                RemoteErrLog.LogException(_main.UserName, _main.Password, _main.SvcUrl, "DGP DGP", "ucApiRoles", ex);
        ...
        public void SetPageSize()
        {
            try
            {
                ...
                string methList = msgUtil.CreateXMLMethod("APIRole.GetPageSize.base", methparams);
                ...
                if (respmsg != "")
                {
                    ...
                    ResInfo methresult = msgUtil.GetResult("APIRole.GetPageSize.base_DEFAULT", methresults);
                    ...
                    {
                        RemoteErrLog.LogError(_main.UserName, _main.Password, _main.SvcUrl, "DGP DGP", "ucApiRoles.SetPageSize", "", "");
            ...
            {
                RemoteErrLog.LogException(_main.UserName, _main.Password, _main.SvcUrl, "DGP DGP", "ucApiRoles.SetPageSize", ex);
        ...
        public void Search()
        {
            ...
            try
            {
                ...
                if (respmsg != "")
                {
                    ...
                    else
                    {
                        ...
                        RemoteErrLog.LogError(_main.UserName, _main.Password, _main.SvcUrl, "DGP DGP", "ucApiRoles.GetSearch", "Authentication error.", errmsg);
            ...
            {
                RemoteErrLog.LogException(_main.UserName, _main.Password, _main.SvcUrl, "DGP DGP", "ucApiRoles.GetSearch", ex);
        ...
        {
            frmEditRole editRole = new frmEditRole(_main, this, "");
            editRole.ShowDialog();
        }
        ...
        {
            frmEditRole editRole = new frmEditRole(_main, this, GID);
            editRole.ShowDialog();
        }

        private void roleMethodsMenuItem_Click(object sender, EventArgs e)
        {
            frmRoleMethods roleMethods = new frmRoleMethods(_main, this, GID, _rolename);
        ...
        {
            frmRoleHist roleHist = new frmRoleHist(_main, this, GID, _rolename);
            roleHist.ShowDialog();
        }
    }
}
