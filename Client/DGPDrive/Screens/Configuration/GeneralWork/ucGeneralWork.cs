...
{
    public partial class ucGeneralWork : UserControl, IDriveUC
    {
        MainForm _main;
        ...
        public ucGeneralWork(MainForm main)
        {
            InitializeComponent();
            ...
            {
                RemoteErrLog.LogException(_main.UserName, _main.Password, _main.SvcUrl, "DGP DGP", "ucGeneralWork", ex);
        ...
        public void SetPageSize()
        {
            try
            {
                ...
                string methList = msgUtil.CreateXMLMethod("GeneralWork.GetPageSize.base", methparams);
                ...
                if (respmsg != "")
                {
                    ...
                    {
                        RemoteErrLog.LogError(_main.UserName, _main.Password, _main.SvcUrl, "DGP DGP", "ucGeneralWork.SetPageSize", "Page Size error", methresult.RVal);
            ...
            {
                RemoteErrLog.LogException(_main.UserName, _main.Password, _main.SvcUrl, "DGP DGP", "ucGeneralWork.SetPageSize", ex);
        ...
        public void Search()
        {
            try
            {
                ...
                if (respmsg != "")
                {
                    ...
                    _main.SetMetrics(2, sw.Elapsed.TotalMilliseconds, Convert.ToDouble(respinfo.SvrMS), "DGP", "ucGeneralWork");
                            ...
                            if (search.RCode.ToUpper() == APIResult.OK || search.RCode.ToUpper() == APIResult.Empty)
                            {
                                if (search.DType == APIData.DataTable)
                                {
                                    ...
                                    if (methList.Rows.Count > 0)
                                    {
                                        ...
                                        dgvGeneralWork.Columns[WorkFields.SchemaTable].FillWeight = 15;
                                        dgvGeneralWork.Columns[WorkFields.SrcURL].FillWeight = 15;
                                        dgvGeneralWork.Columns[WorkFields.SrcMethod].FillWeight = 15;
                                        dgvGeneralWork.Columns[WorkFields.DestURL].FillWeight = 15;
                                        dgvGeneralWork.Columns[WorkFields.DestMethod].FillWeight = 15;
                                    }
                                    else
                                    {
                    ...
                    else
                    {
                        ...
                        RemoteErrLog.LogError(_main.UserName, _main.Password, _main.SvcUrl, "DGP DGP", "ucGeneralWork.GetSearch", "Authentication error.", errmsg);
            ...
            {
                RemoteErrLog.LogException(_main.UserName, _main.Password, _main.SvcUrl, "DGP DGP", "ucGeneralWork.GetSearch", ex);
        ...
        {
            frmEditGeneral editGeneral = new frmEditGeneral(_main, this, "");
        ...
        {
            frmEditGeneral editGeneral = new frmEditGeneral(_main, this, GID);
            editGeneral.ShowDialog();
        }
        ...
        private void cloneMenuItem_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                MsgUtil msgUtil = new MsgUtil();
                string reqID = msgUtil.GetNewGID();
                string methList = msgUtil.CreateXMLMethod("GeneralWork.Clone.base", methparams);
                SOAPMsgUtil soapmsg = new SOAPMsgUtil();
                string respmsg = soapmsg.SOAPApiHelper(methList, reqID, _main.UserName, _main.Password, _main.SvcUrl, _main.SvcPubKey);
                ...
                if (respmsg != "")
                {
                    ...
                    ResInfo methresult = msgUtil.GetResult("GeneralWork.Clone.base_DEFAULT", methresults);
            ...
            {
                RemoteErrLog.LogException(_main.UserName, _main.Password, _main.SvcUrl, "DGP DGP", "frmEditReplica:btnDelete_Click", ex);
